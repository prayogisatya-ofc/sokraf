				...
				<div className="mx-auto max-w-screen-xl">
					...
					<div className="mb-4 grid gap-4 sm:grid-cols-2 md:mb-8 lg:grid-cols-3 xl:grid-cols-4">
						<div className="rounded-lg border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
							...
							<div className="pt-6">
								<Link href='' className="text-lg font-semibold leading-tight text-gray-900 hover:underline dark:text-white">Gelang Dari Kayu</Link>
								...
								<ul className="mt-2 flex items-center gap-4">
									<li className="flex items-center gap-2">
										...
										<p className="text-sm font-medium text-gray-500 dark:text-gray-400">Kerajinan Tangan</p>
									</li>
								</ul>

								<div className="mt-4 flex items-center justify-between gap-4">
									<p className="text-xl font-bold leading-tight">Rp 50.000</p>
								</div>
							</div>
						</div>
					</div>
